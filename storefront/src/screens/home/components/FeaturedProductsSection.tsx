	...
	return (
		<section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
			<div className="text-center">
				<h2 className="text-3xl font-bold tracking-tight text-neutral-900 sm:text-4xl">Featured Products</h2>
				<p className="mt-4 text-lg text-neutral-600">Discover our handpicked selection of premium products</p>
			</div>

			<ul role="list" className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
