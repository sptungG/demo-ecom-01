...
export const getTilesData = ({
  ...
  //     <Paragraph>
  //       <FormattedMessage
  //         defaultMessage="Add new functionalities on top of Saleor and integrate it with third-party services. They can beinstalled, managed, and rendered in here in Saleor Dashboard."
  //         id="XVQpjm"
  //       />
  //     </Paragraph>
  //   ),
